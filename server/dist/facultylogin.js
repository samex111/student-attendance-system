...
exports.facultyRouter.post("/verify-otp", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.facultyRouter.post('/signin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield schema_js_1.FacultyModel.findOne({ $or: [{ username: identifire }, { email: identifire }] });
